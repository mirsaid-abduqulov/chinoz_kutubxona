...
import { UpdateMediaItemOrderDto } from './dto/update-media-item-order.dto';
...
export class MediaController {
   ...
   */
  @Get()
  @ApiOperation({ summary: 'Barcha mediya albumlarini olish' })
  ...
  @ApiOperation({ summary: 'Bitta albumni va uning item larini olish' })
